    ...
    const authConfigContent = useMemo<{
        ...
        if (showRecoveryInput) {
            return {
                ...
                description:
                    t('Harap konfirmasi akses ke akun Anda dengan memasukkan salah satu kode pemulihan darurat Anda.'),
        ...
        return {
            ...
            description:
                t('Masukkan kode autentikasi yang disediakan oleh aplikasi autentikator Anda.'),

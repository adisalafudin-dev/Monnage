...
import { redirect as googleLoginRedirect } from '@/routes/auth/google';
    ...
    return (
        <>
            ...
            <Button variant="outline" className="mb-6 w-full" asChild>
                <a href={googleLoginRedirect.url()}>
                    <svg
                        className="size-4"
                        viewBox="0 0 24 24"
                        aria-hidden="true"
...
Login.layout = {
    ...
    description: 'Masuk untuk melanjutkan pengelolaan keuangan Anda.',
};

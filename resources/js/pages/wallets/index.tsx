...
export default function Wallets({ wallets }: Props) {
    ...
    function deleteWallet(wallet: Wallet) {
        if (!window.confirm(`Hapus dompet “${wallet.title}”?`)) return;

        router.delete(destroy.url(wallet));
    }
            ...
            <div className="flex flex-1 flex-col gap-6 p-4 md:p-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div className="text-2xl font-bold tracking-tight">
                                {wallets.filter((wallet) => wallet.status).length}
                            </div>
                            <CardDescription className="mt-1 text-xs">
            ...
            <Dialog open={isDialogOpen} onOpenChange={(open) => !open && closeDialog()}>
                <DialogContent>
                    ...
                    <form className="grid gap-4" onSubmit={submit}>
                        ...
                        <div className="grid gap-2">
                            <Label htmlFor="wallet-description">Deskripsi <span className="text-muted-foreground">(opsional)</span></Label>
                            <Textarea
